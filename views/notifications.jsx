  ...
  render: function() {
    return (
     <li className = "list-group-item">
       ...
       <a href = {this.props.data.member.html_url}> { this.props.data.member.login } </a> to
       <a href = { this.props.data.repository.html_url}> { this.props.repository.full_name} </a>
     </li>
    );
  }
});
  ...
  render: function() {
    return (
      <li className = "list-group-item">
        ...
        deleted
        {this.props.data.payload.ref_type} { this.props.data.payload.ref } in
...
var Notification = React.createClass({
  getInitialState: function() {
    return {
      toWatch: ["RepositoryEvent", "PublicEvent", "MemberEvent", "ForkEvent", "DeleteEvent", "CreateEvent"],
      components: [Events.RepositoryComponent,
                   Events.PublicComponent,
                   Events.MemberComponent,
                   Events.ForkComponent, Events.DeleteComponent, Events.CreateComponent],
      notifiers: []
    }
  },
